...
public class Assembler {
	...
	private void setType() throws BadInstructionException
	{
		...
		try{
			...
			System.out.println("Unable to determine type");
	...
	private void setInstruction()
	{
		...
		System.out.println(binary);//bug checking
	...
	{ 
		try{
			if(immediate > 15){
				...
				System.out.println(this.immediate);//debug 
			}
	...
	public void setLabel(int pc){
		...
		if(pc>=0){
			...
			System.out.println(this.label);//debug
		}
		else{
	...
	private void setCondition() throws BadInstructionException{
		...
		System.out.println(cond);//bug checking
	...
	public void setOperation(String op) throws NumberFormatException, OverFlowException{
		...
		try{
			...
			System.out.println("invalid operation, look at documentation for valid instruction inputs");
			e.printStackTrace();
		}
